# -*- coding: utf-8 -*-
"""
Export Facebook cookies + localStorage/sessionStorage from a real Chrome profile.

- Launches Chrome with your specified user-data-dir + profile-directory
- Uses CDP to read ALL cookies (includes HttpOnly) and filters by allowed domains
- Visits a list of FB origins to dump localStorage and sessionStorage via JS
- Writes:
    cookies.json        -> list[ cookie ]
    localstorage.json   -> dict[str, str]
    sessionstorage.json -> dict[str, str]   (optional convenience)

NOTE: This script only reads from your real profile; it does not modify it.
"""
...
# File output
OUT_COOKIES_PATH       = "cookies.json"
OUT_LOCALSTORAGE_PATH  = "localstorage.json"
OUT_SESSIONSTORAGE_PATH= "sessionstorage.json"
