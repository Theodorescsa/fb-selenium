...
from config import *
import time
import os, re, json, time, random, urllib.parse, subprocess
...
class Crawler:
    ...
    def run(self):
        ...
        if cursor:
            ...
            Utils.save_checkpoint(self.checkpoint, cursor, seen_ids, last_doc_id=form.get('doc_id'),
                                  last_query_name=friendly, vars_template=template_now)
            page = 1
